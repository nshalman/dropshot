...
//!   recorded for error responses and client disconnects
//!   (`error.type = "client_disconnect"`, with a synthetic 499 status
//!   code).  A handler panic that propagates out of request handling is
//!   indistinguishable from a disconnect here and is reported the same way.
